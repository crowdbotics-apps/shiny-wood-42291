"""
Django settings for shiny_wood_42291 project.
...
ROOT_URLCONF = 'shiny_wood_42291.urls'
...
WSGI_APPLICATION = 'shiny_wood_42291.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "shiny_wood_42291 API",
    "DESCRIPTION": "API documentation for shiny_wood_42291 App",
    "VERSION": "v1",
}
